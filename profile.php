...
<div class="form-group row">
	<label for="uname" class="col-sm-1 col-form-label">Userame: </label>
	<div class="col-sm-9">
...
<div class="form-group row">
	<label class="col-form-legend col-sm-1" for="gender">Gender: </label>
	<div class="col-sm-9">
		<?php echo $userinfo['gender']; ?>
	</div>
</div>
<div class="form-group row">
	<label class="col-form-legend col-sm-1" for="utype">User Type: </label>
	<div class="col-sm-9">
