...
if (isset($_POST['add'])) {
    ...
    $conn = initDB();
    $sql = "insert into buses (bname, bus_no, from_loc, from_time, to_loc, to_time, fare, approved, owner_id) values ('";
    $sql .= $_POST['bname'] . "','" . $_POST['bus_no'] . "','" . $_POST['from_loc'] . "','" . $_POST['from_time'] . "','";
    $sql .= $_POST['to_loc'] . "','" . $_POST['to_time'] . "','" . $_POST['fare'] . "','" . $_POST['approved'] . "', '" . $_SESSION['user']['id'] . "')";
    if ($conn->query($sql)) {
        $add = "ok";
    } else {
...
<div class="modal" tabindex="-1" role="dialog"
    style="display: <?php echo ($_GET['act'] == 'add') ? 'block' : 'none'; ?>">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="my_buses.php">
                ...
                <div class="modal-footer">
                    ...
                    <a href="my_buses.php"><button type="button" class="btn btn-secondary"
