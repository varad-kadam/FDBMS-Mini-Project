...
t_header("Ticket Booking &mdash; Buy Tickets");
t_login_nav();
t_sidebar();
...
if (isset($_POST['buy'])) {
  ...
  if (!isset($_POST['seats']) || $_POST['seats'] == "") {
    ...
    if ($conn->query($sql)) {
      echo '<div class="alert alert-success">Purchase <strong>Successfull!</strong><a class="text-right col-md-4" href="print.php?ticket=' . $conn->insert_id . '"><button class="btn btn-info">Print Ticket</button></a></div>';
    } else {
...
<form action="" method="get">
  <div class="form-group row">
    <label for="from" class="col-sm-1 col-form-label">Source: </label>
  ...
  <div class="form-group row">
    <label for="to" class="col-sm-1 col-form-label">Destination: </label>
    <div class="col-sm-7">
  ...
  <div class="form-group row">
    <label for="jdate" class="col-sm-1 col-form-label">Journey Date: </label>
    <div class="col-sm-7 input-group">
      <input name="jdate" class="form-control" id="inputJDate" type="text"
        value="<?php echo (isset($_GET['jdate'])) ? $_GET['jdate'] : ''; ?>" />
    </div>
  </div>
...
<div class="table-con">
  <div class="row">
    ...
    <div class="col-sm-2">Departure Time</div>
    <div class="col-sm-2">Arrival Time</div>
    <div class="col-sm-2">Fare (Rs.)</div>
  </div>
  <?php
  require_once 'inc/database.php';
  $conn = initDB();
  ...
  if ($res->num_rows == 0 || !isset($_GET['jdate']) || $_GET['jdate'] == '') {
    echo '<div class="row">
    <div class="col-sm-12 text-center"><h4>No Bus Found</h4></div>
  </div>';
  } else {
