...
<table width="100%">
	<tr>
		<td width="70%">
			<img src="./img/cover_bus.jpg" alt="Background" height="100%" />
			</div>
		<td width="30%">
			<?php
			if ($acc != "") {
			...
			<form action="index.php" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-7 px-5">
						<input class="form-check-input" type="radio" name="gender" id="radioMale" value="1" checked>
						Male <br />
				...
				<div class="form-group row">
					...
					<div class="col-sm-7 px-5">
						<input class="form-check-input" type="radio" name="utype" id="radioPass" value="3" checked>
						Passenger <br />
				...
				<script
					src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDT6virNnyW0tcOqRcxKpdKENTESrp4ojE&libraries=places&callback=initialize"
					async defer></script>
				<div class="form-group row">
