...
<div class="navbar fixed-top navbar-default header">
	<div class="container-fluid">
		<h3>FDBMS Bus Ticket Booking System</h3>
	...
	<div class="row">
		<div class="col-md-2 sidebar">
				<ul>
					...
					<li><a href="history.php"' . (($file == 'history') ? 'class="active"' : '') . '><i class="fa fa-history"></i> Ride History</a></li>
				</ul>
		</div>
...
function t_footer()
{
	...
	<div class="footer">
		<div class="row p-4">
			<div class="col-md-4">FDBMS Mini Project. Batch A3. Made late at night, and under great stress, imaginary copyright 2023 - Infinity. </div>
			...
			<ul class="list-null">
				<li><a target="_blank" href="//www.linkedin.com/in/kadamvarad/"><i class="fa fa-facebook"></i></a></li>
				<li><a target="_blank" href="//www.linkedin.com/in/kadamvarad/"><i class="fa fa-instagram"></i></a></li>
				<li><a target="_blank" href="//www.linkedin.com/in/kadamvarad/"><i class="fa fa-linkedin"></i></a></li>
				<li><a target="_blank" href="//www.linkedin.com/in/kadamvarad/"><i class="fa fa-twitter"></i></a></li>
			</ul>
			</div>
		</div>
	</div>
